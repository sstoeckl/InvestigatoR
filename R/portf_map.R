...
#'
#' @examples xy
portf_map <- function(t, data, features,ticks, t_oos, m_offset, train_size, weight_func){
  ...
  temp_weights <- weight_func(train_data = train_data, test_data = test_data, features = features)      # Weights calculation
